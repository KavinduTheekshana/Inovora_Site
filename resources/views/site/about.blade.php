        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="page-subtitle">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since </div>
                </div>
            </div>
        </div>
    </div>
...
<section id="page-helf-photo" >
    ...
    <div class="right-helf-of-page">
        ...
        <div class="feturest-of-helf">
            <span><i class="fa fa-check" aria-hidden="true"></i> personal themes</span>
            <span><i class="fa fa-check" aria-hidden="true"></i> Professional service</span>
            <span><i class="fa fa-check" aria-hidden="true"></i> Ghost Servers</span>
            <span><i class="fa fa-check" aria-hidden="true"></i> Technical support</span>
...
<section id="hositng-plans" >
  ...
  <section>
  <div class="section-testimonial-carousel section-pt section-pb2" style="padding: 50px 0;background: #eff1fe;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
