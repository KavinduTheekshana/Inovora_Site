        ...
        <div class="row">
            <div class="col-md-12">
                <div class="content-holder">
                    <p>Welcome to INOVORA. These terms and conditions outline the rules and regulations for the use of Company Name's Website,
                        located at INOVORA.UK. By accessing this website we assume you accept these terms and conditions. Do not continue to use INOVORA.UK 
                        ...
                        The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: “Client”,
                         “You” and “Your” refers to you, the person log on this website and compliant to the Company's terms and conditions. “The Company”, 
                         “Ourselves”, “We”, “Our” and “Us”, refers to our Company. “Party”, “Parties”, or “Us”, refers to both the Client and ourselves. 
                         ...
                         Client in the most appropriate manner for the express purpose of meeting the Client's needs in respect of provision of the Company's 
                         stated services, in accordance with and subject to, prevailing law of Netherlands. Any use of the above terminology or other words in
                          the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>

                    <h4>Cookies</h4>

                    <p>We employ the use of cookies. By accessing INOVORA.UK, you agreed to use cookies in agreement with the 
                        INOVORA's Privacy Policy.<br><br>Most interactive websites use cookies to let us retrieve the user's details for each 
                    ...
                    <p>Unless otherwise stated, INOVORA and/or its licensors own the intellectual property rights for all material on 
                        INOVORA.UK. All intellectual property rights are reserved. You may access this from INOVORA.UK for your own 
                        personal use subjected to restrictions set in these terms and conditions.<br><br>
                        You must not:<br><br>
                            <ul>
                                <li>Republish material from INOVORA.UK</li>
                                <li>Sell, rent or sub-license material from INOVORA.UK</li>
                                <li>Reproduce, duplicate or copy material from INOVORA.UK</li>
                                <li>Redistribute content from INOVORA.UK</li>
                            </ul><br><br></p><p>
                        ...
                        areas of the website. INOVORA does not filter, edit, publish or review Comments prior to their presence on the 
                        website. Comments do not reflect the views and opinions of INOVORA,its agents and/or affiliates. Comments reflect 
                        the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, 
                        INOVORA shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a 
                        result of any use of and/or posting of and/or appearance of the Comments on this website.<br><br>

                        INOVORA reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, 
                        offensive or causes breach of these Terms and Conditions.<br><br>
                        You warrant and represent that:<br><br>
                            ...
                            You hereby grant INOVORA a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your
                    ...
                    <p>The following organizations may link to our Website without prior written approval:
                        ...
                        of the linking party and its products and/or services; and (c) fits within the context of the linking party's
                        site.<br><br>
                        ...
                        from the visibility of the hyperlink compensates the absence of INOVORA; and (d) the link is in the context of general resource
                         information.</p>
                        <p>
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must 
                            inform us by sending an e-mail to Company Name. Please include your name, your organization name, contact information as 
                        ...
                        <p>No use of INOVORA's logo or other artwork will be allowed for linking absent a trademark license agreement.
                    ...
                    </p><p>We do not ensure that the information on this website is correct, we do not warrant its completeness or 
