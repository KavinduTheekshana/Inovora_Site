        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="project-count-inner domain-inner-bg">
                    <div class="row">
                        <div class="col-lg-3 col-sm-6" data-animscroll="fade-in" data-animscroll-delay="250">
                            <!-- counter start -->
                        ...
                        <div class="col-lg-3 col-sm-6" data-animscroll="fade-in" data-animscroll-delay="500">
                            <!-- counter start -->
                            <div class="counter text-center mt-30">
                        ...
                        <div class="col-lg-3 col-sm-6" data-animscroll="fade-in" data-animscroll-delay="100">
                            <!-- counter start -->
                            <div class="counter text-center mt-30">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <!-- counter start -->
                            <div class="counter text-center mt-30" data-animscroll="fade-in" data-animscroll-delay="750">
